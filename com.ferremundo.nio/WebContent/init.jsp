...
<div class="ui-widget">
	...
	<button type="button" onclick="new fillCommandLine('@ic');">cotizar a cliente</button>
	<button type="button" onclick="new fillCommandLine('@ia');">cotizar a agente</button>
	<button type="button" onclick="new fillCommandLine('@oc');">credito a cliente</button>
	<button type="button" onclick="new fillCommandLine('@oa');">credito a agente</button>
	<button type="button" onclick="new fillCommandLine('$oc');">pedido a cliente+abono</button>
	<button type="button" onclick="new fillCommandLine('$oa');">pedido a agente+abono</button>
	<button type="button" onclick="new fillCommandLine('$fc');">factura a cliente+abono</button>
	<button type="button" onclick="new fillCommandLine('$fa');">factura a agente+abono</button>
	<p class="g-total2">$0</p>
	<p class="g-area-to-print">0 - 0 hojas</p>
	<div id="editproduct">
		<input id="editproduct-1" />
		<input id="editproduct-2"/>
		<input id="editproduct-3"/>
		<input id="editproduct-4"/>
