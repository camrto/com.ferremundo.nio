...
(function($){$.capsule([

	{
		...
		name:'com.ferremundo.cps.SexyRowT',
		...
		html:function(){
			var gd=this.get('com.ferremundo.cps.GenericTC');
...

	{
		...
		name:'com.ferremundo.cps.SexyRow',
		...
		html:function(){
			var gd=this.get('com.ferremundo.cps.GenericDiv');
